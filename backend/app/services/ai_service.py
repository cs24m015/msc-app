    ...
    if vulnerability.references:
        for ref in vulnerability.references:
            ...
            if any(pattern in ref_lower for pattern in [
                ...
                # Security databases / aggregators
                ...
                'whitehatsec.com/vulnerability/',
                'rapid7.com/db/vulnerabilities/',
                'tenable.com/plugins/',
                'tenable.com/cve/',
                ...
                'us-cert.cisa.gov/ncas/current-activity/',
                'kb.cert.org/vuls/id/',
                'cert.europa.eu/publications/security-advisories/',
                'govcert.ch/blog/',
                'cert.at/de/warnungen/',

                # Project-specific advisories
                'nodejs.org/en/security/',
                'python.org/news/security/',
                'ruby-lang.org/en/news/',
                'golang.org/security/',
                'openssl.org/news/secadv/',
                'nginx.org/en/security_advisories.html',
                'httpd.apache.org/security/',
                'tomcat.apache.org/security-',
                'kubernetes.io/blog/',
                'kubernetes.io/security/',
                'rustsec.org/advisories/',
                'github.com/rustsec/advisories/',
                'pkg.go.dev/vuln/',
                ...
                'rubysec.com/advisories/',
                'github.com/rubysec/ruby-advisory-db/',
                'mvnrepository.com/vulnerability/',
                'friendsphp.org/security/advisories/',
                'packagist.org/security-advisories/',
