...
- `scans.py` — SCA-Scan-Verwaltung (Submit, Targets inkl. Group-Filter, Target-Gruppen-Roll-up, Findings, SBOM, SBOM-Export, SBOM-Import, Layer-Analyse, VEX, License-Compliance)
